package com.exercise.common.core.util;
...
public class ResponseUtils {
     ...
     * @param result
     */
    public static void out(ServletResponse response, CommonResult result) {
    ...
    public static void getResponse(HttpServletResponse httpServletResponse, String msg, Integer status){
        ...
        try {
            ...
            writer.print(JSONObject.toJSONString(CommonResult.success(msg)));
        } catch (IOException e) {
