package com.exercise.security.log;
...
import com.exercise.common.core.enums.BusinessStatus;
...
public class MyLogAspect implements Ordered
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.exercise.common.core.annotation.MyLog)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            if (currentUser != null)
            {
                ...
                operLog.setUserRealName(currentUser.getFullname());
            }
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, MyLog log, SysOperLog operLog) throws Exception
    {
        // 设置action动作
